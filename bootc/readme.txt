...
sudo podman build --network=host -t nginx-test .
...
tmt --context "distro=rhel-10.0 product=rhel" run -a provision -h virtual --image /home/bnater/git/gitlab.com/rhel/tests/nginx/bootc/output/qcow2/disk.qcow2 tests --filter 'tier:1&component:nginx' plans --name all-non-buildroot report --how reportportal --project baseosqe --launch image-mode-nginx-tier1
